...
int main(int argc, char *argv[]) {
  ...
  ret = utra->moveto_cartesian_line(pos3, speed, acc, 5.0);
  printf("moveto_cartesian_line   :%d\n", (ret));

  ret = utra->moveto_cartesian_circle(pos1, pos2, speed, acc, 5, 50);
  printf("moveto_cartesian_circle   :%d\n", ret);
  ret = utra->moveto_cartesian_circle(pos2, pos3, speed, acc, 5, 100);
  printf("moveto_cartesian_circle   :%d\n", ret);
  ret = utra->moveto_cartesian_circle(pos2, pos1, speed, acc, 5, 125);
  printf("moveto_cartesian_circle   :%d\n", ret);
