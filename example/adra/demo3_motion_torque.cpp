 ...
 * run command(USB-To-RS485 + COM:/dev/ttyUSB0): sudo ./adra/demo3_motion_torque 1 0 0
 * run command(EtherNet-To-RS485 + IP:192.168.1.16): ./adra/demo3_motion_torque 3 0 16
 */
